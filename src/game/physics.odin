...
are_rects_colliding :: proc(rec_a, rec_b: Rectangle) -> bool {
...
is_circle_colliding_rectangle :: proc(circle: Circle, rectangle: Rectangle) -> bool {
	return is_circle_colliding_rectangle_v2(circle, rectangle)
...
is_point_inside_rect :: proc(point: math.Vector2f32, rect: Rectangle) -> bool {
	rect_min, rect_max := get_rect_extends(rect)
